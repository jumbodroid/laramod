...
use Jumbodroid\Laramod\Collection;
use Jumbodroid\Laramod\Contracts\ActivatorInterface;
use Jumbodroid\Laramod\Exceptions\InvalidAssetPath;
use Jumbodroid\Laramod\Exceptions\ModuleNotFoundException;
use Jumbodroid\Laramod\Laravel\LaravelFileRepository;
use Jumbodroid\Laramod\Module;
...
class LaravelFileRepositoryTest extends BaseTestCase
{
    ...
    public function it_gets_the_configured_stubs_path_if_enabled()
    {
        ...
        $this->assertEquals(base_path('vendor/jumbodroid/laravel-modules/src/Commands/stubs'), $this->repository->getStubPath());
    }
