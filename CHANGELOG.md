...
- Fixed bug: `Target class [Jumbodroid\Laramod\Commands\] does not exist.`
...
- **BREAKING** Renamed method `enabled` to `isEnabled` in `\Jumbodroid\Laramod\Module`.
- **BREAKING** Renamed method `disabled` to `isDisabled` in `\Jumbodroid\Laramod\Module`.
- **BREAKING** Renamed method `enabled` to `isEnabled` in `\Jumbodroid\Laramod\FileRepository`.
- **BREAKING** Renamed method `disabled` to `isDisabled` in `\Jumbodroid\Laramod\FileRepository`.
- **BREAKING** Removed the `__get` magic method on the `\Jumbodroid\Laramod\Module` class. Use `get()` or `json()->get()` instead.
