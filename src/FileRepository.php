...
use Jumbodroid\Laramod\Process\Installer;
use Jumbodroid\Laramod\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @param string $args
     * @param string $path
     * @return \Jumbodroid\Laramod\Module
     */
     ...
     * @return string
     * @throws \Jumbodroid\Laramod\Exceptions\ModuleNotFoundException
     */
