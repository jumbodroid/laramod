...
use Jumbodroid\Laramod\Exceptions\InvalidJsonException;
...
class Json
{
    ...
    public function getAttributes()
    {
        ...
        if (config('laramod.cache.enabled') === false) {
            return $attributes;
        }

        return app('cache')->remember($this->getPath(), config('laramod.cache.lifetime'), function () use ($attributes) {
            return $attributes;
        });
    }
